...
const payload = {
  hookSpecificOutput: {
    ...
    additionalContext: [
      ...
      "\n  2. Programmatic inspection: python \"/tmp/claude-1000/-mnt-c-workspace-ai-engineering-robotframework/6fe17ce9-00bd-4179-bc22-dbf725b60a81/scratchpad/rehearsal/repo/.claude/rf-agentskills-files/scripts/rf_results.py\" ",
