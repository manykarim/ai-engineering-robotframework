...
```bash
python3 "/tmp/claude-1000/-mnt-c-workspace-ai-engineering-robotframework/6fe17ce9-00bd-4179-bc22-dbf725b60a81/scratchpad/rehearsal/repo/.claude/rf-agentskills-files/scripts/keyword_builder.py" --input keyword.json
```

Detect embedded-argument style from an existing project:

```bash
python3 "/tmp/claude-1000/-mnt-c-workspace-ai-engineering-robotframework/6fe17ce9-00bd-4179-bc22-dbf725b60a81/scratchpad/rehearsal/repo/.claude/rf-agentskills-files/scripts/keyword_builder.py" --input keyword.json --project-root . --detect-embedded
```
